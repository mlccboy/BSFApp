...
export const Models = {
  ...
  BibleVersions: [
    { DisplayName: "新标点和合本(简体)", Value: "cunpss" },
    { DisplayName: "当代译本(简体)", Value: "ccb" },
    { DisplayName: "新標點和合本(繁體)", Value: "cunpts" },
  ...
  OfflineModes: [
    { DisplayName: "简体中文 + 新标点和合本(简体)", Value: "chs" },
    { DisplayName: "繁體中文 + 新標點和合本(繁體)", Value: "cht" },
